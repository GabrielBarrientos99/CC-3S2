...
public class AirportTest {
    ...
    class EconomyFlightTest {
        ...
        class RegularPassenger {
            ...
            @Test
            @DisplayName("Agregar un pasajero regular que ya esta en lista")
            public void testEconomyFlightRegularAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true, economyFlight.addPassenger(checha)),
                        () -> assertEquals(1, economyFlight.getPassengersList().size()),
        ...
        class VipPassenger {
            ...
            @Test
            @DisplayName("Agregar un pasajero Vip que ya esta en lista")
            public void testEconomyFlightVipAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true, economyFlight.addPassenger(lore)),
                        () -> assertEquals(1, economyFlight.getPassengersList().size()),
    ...
    class BusinessFlightTest {
        ...
        class RegularPassenger {
            ...
            @Test
            @DisplayName("Agregar un pasajero regular que ya esta en lista")
            public void testBusinessFlightRegularAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true, businessFlight.addPassenger(checha)),
        ...
        class VipPassenger {
            ...
            @Test
            @DisplayName("Agregar un pasajero Vip que ya esta en lista")
            public void testBusinessFlightVipAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true,businessFlight.addPassenger(lore)),
                        () -> assertEquals(1, businessFlight.getPassengersList().size()),
    ...
    class PremiumFlightTest{
        ...
        class RegularPassenger {
            ...
            @Test
            @DisplayName("Agregar un pasajero regular que ya esta en lista")
            public void testPremiumFlightRegularAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true,premiumFlight.addPassenger(checha)),
        ...
        class VipPassenger {
            @Test
            @DisplayName("Luego puedes agregarlo pero no puede eliminarlo de un vuelo premium")
            ...
            @Test
            @DisplayName("Agregar un pasajero Vip que ya esta en lista")
            public void testPremiumFlightVipAddSamePassenger() {
                assertAll("Verifica todas las condiciones para un añadir un pasajero de nuevo",
                        () -> assertEquals(true,premiumFlight.addPassenger(lore)),
                        () -> assertEquals(1, premiumFlight.getPassengersList().size()),
